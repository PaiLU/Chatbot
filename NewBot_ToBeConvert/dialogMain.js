...
const luisModelUrl = `https://${luisHostName}/luis/v2.0/apps/${luisAppId}?subscription-key=${luisSubscriptionKey}&spellCheck=true&bing-spell-check-subscription-key=${bingSpellCheckSubscriptionKey}&verbose=true&timezoneOffset=0&q=`;
